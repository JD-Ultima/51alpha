...
namespace Server.Spells
{
    public abstract class MagerySpell : Spell
    {
        ...
        public override TimeSpan GetCastDelay()
        {
            ...
            // Sphere51a: Scroll speed bonus for Circle 3+ - PLAYERS ONLY
            if (Caster.Player && Circle >= SpellCircle.Third && Scroll is SpellScroll)
            {
                var reducedDelay = baseDelay.TotalSeconds - 0.5;
                return TimeSpan.FromSeconds(Math.Max(0.25, reducedDelay));
            }
