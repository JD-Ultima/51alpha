...
{
    public class SummonDaemonSpell : MagerySpell, ITargetingSpell<IPoint3D>
    {
            ...
            else if (SpellHelper.CheckTown(p, Caster))
            {
                ...
                if (Caster.Player)
                {
                    ...
                    SpellEffect = () =>
                    {
                        ...
                        BaseCreature.Summon(new SummonedDaemon(), false, Caster, new Point3D(p), 0x216, duration);
                    };
                    ...
                    // Note: FinishSequence() will be called by CastDelayTimer, not here
                    return;
                }
