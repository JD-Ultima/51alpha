...
{
    public class EarthElementalSpell : MagerySpell, ITargetingSpell<IPoint3D>
    {
            ...
            else if (SpellHelper.CheckTown(p, Caster))
            {
                ...
                if (Caster.Player)
                {
                    ...
                    SpellEffect = () =>
                    {
                        ...
                        BaseCreature.Summon(new SummonedEarthElemental(), false, Caster, new Point3D(p), 0x217, duration);
                    };
