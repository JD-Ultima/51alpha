...
namespace Server.Mobiles
{
    ...
    // Sphere51a: Monster Family system for weapon bonus targeting
    public enum MonsterFamily
    {
        None = 0,
        Humanoid,    // Ettins, Trolls, Ogres, Lizardmen, Brigands
        Beast,       // Dire Wolves, Boars, Scorpions, Feral creatures
        Crystalline, // Juka Warriors, Juka Lords, Crystal creatures
        Dragon,      // Drakes, Wyverns, Dragons, Wyrms
        Elemental,   // Earth, Fire, Water, Air, Poison, Blood, Acid elementals
        Giant,       // Cyclops, OgreLords, Titans
        Aquatic,     // Krakens, SeaSerpents, Water creatures
        Serpent,     // Giant Serpents, Snakes
        Demonic,     // Daemons, Demons
        Stone        // Golems, Golem Controllers, Stone constructs
    }
    ...
    public abstract partial class BaseCreature : Mobile, IHonorTarget, IQuestGiver
    {
        ...
        */
        ...
        // Sphere51a: Monster Family property for weapon bonus system
        public virtual MonsterFamily Family => MonsterFamily.None;
