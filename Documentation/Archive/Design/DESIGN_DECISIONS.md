...
**4-Piece System:**
| Piece | Stats per Piece |
|-------|-----------------|
| Ring | +2.5 Str, +2.5 Dex, +2.5 Int |
| Bracelet | +2.5 Str, +2.5 Dex, +2.5 Int |
| Earrings | +2.5 Str, +2.5 Dex, +2.5 Int |
| Glasses | +2.5 Str, +2.5 Dex, +2.5 Int |
...
### Schedule
- **Hourly rotation**: One city per hour
...
- Standard UO VvV system as reference
- Town guards, objectives, scoring per VvV

### Town Control
- **Persistent** until recaptured (not time-limited)
- Town Cryer announces current ownership
- Benefits: TBD in implementation (NPC merchants, bonuses)
